...
/* —————————— A Geometria Sagrada do Voo ——————————
  ...
  #define CICLO_DO_CORACAO_ALADO  0.15f  /* segundos (~6.7 Hz) */
#endif
#ifndef LIMIAR_DO_VOO_ATIVO
  #define LIMIAR_DO_VOO_ATIVO          1120
#endif
...
/* —————————— O Hálito que Sustenta ——————————
  ...
  #define FORCA_BASE_DO_SUSTENTAR         40
#endif
#ifndef SILENCIO_DO_SUSTENTAR_M
  #define SILENCIO_DO_SUSTENTAR_M         2.5f
#endif
...
/* —————————— A Dança Secreta dos Ventos ——————————
  ...
  #define PESO_VELOCIDADE_VERTICAL_ATUAL      0.15f
#endif
#ifndef PESO_VELOCIDADE_VERTICAL_ANTERIOR
  #define PESO_VELOCIDADE_VERTICAL_ANTERIOR   0.85f
#endif
  ...
  #define GANHO_LIMIAR_SUSTENTAR          0.30f
#endif
